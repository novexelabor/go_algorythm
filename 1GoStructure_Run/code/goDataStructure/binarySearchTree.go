...
func (bst *BinarySearchTree) PreOrder() { //临时抵押
...
func (bst *BinarySearchTree) MidOrder() { //智力测验
...
func (bst *BinarySearchTree) PostOrder() { //副作用
...
func (bst *BinarySearchTree) Min() Comparable { //附带条件
	if bst.size == 0 {
		return nil
	}
...
func (bst *BinarySearchTree) Max() Comparable { //远程教育
	if bst.size == 0 {
		return nil
	}
